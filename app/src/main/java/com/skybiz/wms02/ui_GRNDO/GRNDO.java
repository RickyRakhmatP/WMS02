...
public class GRNDO extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grndo);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("GRN DO");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_grndo, menu);
        return true;
    }
    ...
    public void retDetail(){
        ...
        DownloaderOrder dOrder=new DownloaderOrder(this,"GRNDO", rvDetail,this.getSupportFragmentManager());
        dOrder.execute();
    }
    public void retItem(String ItemGroup){
        ...
        if(ItemGroup.equals("Miscellaneous")) {
            ...
            DownloaderItem dItem = new DownloaderItem(this, "GRNDO", ItemGroup, rvItem);
            dItem.execute();
        }
    }
    ...
    public void newRefresh(){
        finish();
        Intent mainIntent = new Intent(this, GRNDO.class);
