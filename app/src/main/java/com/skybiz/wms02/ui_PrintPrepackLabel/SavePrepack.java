...
import com.skybiz.wms02.ui_PrintPrepackLabel.m_ListDetail.ListCSParser;
...
public class SavePrepack extends AsyncTask<Void,Void,String> {

    Context c;
    String Doc1No,Qty,ComName,CusName,Address;
    String IPAddress,UserName,Password,DBName,Port,URL,z,DBStatus,CharType;
    String jsonData;

    public SavePrepack(Context c, String doc1No, String qty, String CusName, String Address) {
        this.c = c;
        Doc1No = doc1No;
        Qty = qty;
    ...
    protected void onPostExecute(String result) {
        ...
        if(result.equals("success")){
            ...
            ((PrintPrepackLabel)c).setPrint(jsonData);
        }else{
