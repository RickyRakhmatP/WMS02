...
public class ReceiptStock extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_receipt_stock);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Receipt Stock");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_receipt_stock, menu);
        return true;
    }
    ...
    public void retDetail(){
        ...
        DownloaderOrder dOrder=new DownloaderOrder(this,"RS", rvDetail,this.getSupportFragmentManager());
        dOrder.execute();
    }
    public void retItem(String ItemGroup){
        ...
        if(ItemGroup.equals("Miscellaneous")) {
            ...
            DownloaderItem dItem = new DownloaderItem(this, "RS", ItemGroup, rvItem);
            dItem.execute();
        }
    }
    ...
    public void newRefresh(){
        finish();
        Intent mainIntent = new Intent(this, ReceiptStock.class);
