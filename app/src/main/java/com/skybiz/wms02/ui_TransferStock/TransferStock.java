...
public class TransferStock extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtLocationCodeTo=(TextView)findViewById(R.id.txtLocationCodeTo);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_transfer_stock, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.mnSupplier) {
            ...
            return true;
        }else if(id==R.id.mnLocTo){
            Bundle b=new Bundle();
            b.putString("DOCTYPE_KEY","TS");
            b.putString("DBSTATUS_KEY","All");
    ...
    public void retDetail(){
        ...
        DownloaderOrder dOrder=new DownloaderOrder(this,"TS", rvDetail,this.getSupportFragmentManager());
        dOrder.execute();
    }
    public void retItem(String ItemGroup){
        ...
        if(ItemGroup.equals("Miscellaneous")) {
            ...
            DownloaderItem dItem = new DownloaderItem(this, "TS", ItemGroup, rvItem);
            dItem.execute();
        }
    }
    ...
    public void newRefresh(){
        finish();
        Intent mainIntent = new Intent(this, TransferStock.class);
        startActivity(mainIntent);
    }
    public void setSubTitle(String LocationCode){
        DBAdapter db=new DBAdapter(this);
        db.openDB();
        String vDel="delete from tb_location";
        db.exeQuery(vDel);
        String insert="insert into tb_location(LocationCode,LocationCodeTo,Remark)values(" +
                "'', '"+LocationCode+"', '')";
        db.exeQuery(insert);
        db.closeDB();
        getSupportActionBar().setSubtitle("To : "+LocationCode);

    }
    public void setLocation(String LocatioCode){
        txtLocationCodeTo.setText(LocatioCode);
    }
}
