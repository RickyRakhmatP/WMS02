...
public class Fragment_Detail extends Fragment {
    ...
    private void retDetail(){
        ...
        DownloaderOrder dOrder=new DownloaderOrder(getActivity(),"IS", rvDetail,getActivity().getSupportFragmentManager());
        dOrder.execute();
    }

    public void fnAddSearch(Context c, String ItemCode){
        String vQty="1";
        AddItem_BySearch fnaddsearch=new AddItem_BySearch(c, "IS", ItemCode,vQty);
        fnaddsearch.execute();
    }
}
