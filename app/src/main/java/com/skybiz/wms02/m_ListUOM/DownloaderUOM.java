...
public class DownloaderUOM extends AsyncTask<Void,Void,String> {
    ...
    public DownloaderUOM(Context c,String ItemCode, RecyclerView rv, DialogQty dialogQty) {
        this.c = c;
        this.rv = rv;
        ...
        try {
            ...
            if(DBStatus.equals("1")){
                ...
                String vQuery ="select  UOM, UOM1, UOM2, UOM3, UOM4, " +
                        " IFNULL(UnitPrice,0)as UnitPrice, IFNULL(UOMPrice1,0)as UOMPrice1," +
                        " IFNULL(UOMPrice2,0)as UOMPrice2, IFNULL(UOMPrice3,0)as UOMPrice3," +
                        " IFNULL(UOMPrice4,0)as UOMPrice4, " +
                        " UOMFactor1, UOMFactor2, UOMFactor3, UOMFactor4 " +
                        " from stk_master where ItemCode='"+ItemCode+"' ";
